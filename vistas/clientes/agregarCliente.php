...
if( isset( $_POST["nombre"] ) && !empty($_POST["nombre"])){
    ...
    $agregaCliente = agregarCliente($data);
...
<div class="container">
    <div class="row">
        <div class="col mt-5">
            <form autocomplete="off" id="agregarCliente" method="post" action="">

                <div class="form-group">
                    <label for="nombreCliente">Nombre del cliente</label>
                    <input type="text" required name="nombre" class="form-control">
                    <div class="invalid-feedback">Agrega el nombre del cliente</div>
                </div>

                <button class="btn btn-primary btn-block"> Agregar Cliente </button>
                <a href="<?php echo URL; ?>vistas/clientes/listarClientes.php" class="btn btn-secondary btn-block"> Ver listado </a>
...
<script src="../../dist/js/clientes/agregarCliente.js"></script>
